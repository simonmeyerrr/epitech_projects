...
void nts::C4514::setLink(std::size_t pin, nts::IComponent &other, std::size_t other_pin)
{
...
{
    std::cout << "4514 " << getName() << std::endl;
    for (size_t i = 1; i <= 24; i++) {
        std::cout << "-pin" << i << ": ";
        if (getPinType(i) == OUT)
            std::cout << "output";
...
void nts::C4514::updateState(nts::Tristate state)
{
    (void)state;
}

nts::PinType nts::C4514::getPinType(std::size_t pin) const
{
...
nts::Tristate nts::C4514::exec_compute_any(std::size_t pin1, std::size_t pin2,
...
nts::Tristate nts::C4514::exec_compute_one(std::size_t pin1, std::size_t pin2,
    std::size_t pin3, std::size_t pin4, std::size_t pin5, std::size_t pin6)
{
    Link *link1 = _pins.at(pin1);
    Link *link2 = _pins.at(pin2);
...
nts::Tristate nts::C4514::exec_compute_two(std::size_t pin1, std::size_t pin2,
    std::size_t pin3, std::size_t pin4, std::size_t pin5, std::size_t pin6)
{
    Link *link1 = _pins.at(pin1);
    Link *link2 = _pins.at(pin2);
...
nts::Tristate nts::C4514::exec_compute_three(std::size_t pin1, std::size_t pin2,
    std::size_t pin3, std::size_t pin4, std::size_t pin5, std::size_t pin6)
{
    Link *link1 = _pins.at(pin1);
    Link *link2 = _pins.at(pin2);
...
nts::Tristate nts::C4514::exec_compute_four(std::size_t pin1, std::size_t pin2,
    std::size_t pin3, std::size_t pin4, std::size_t pin5, std::size_t pin6)
{
    Link *link1 = _pins.at(pin1);
    Link *link2 = _pins.at(pin2);

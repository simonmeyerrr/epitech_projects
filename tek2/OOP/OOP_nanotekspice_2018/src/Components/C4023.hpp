...
#ifndef OOP_NANOTEKSPICE_2018_C4023_HPP
#define OOP_NANOTEKSPICE_2018_C4023_HPP
...
namespace nts {
    ...
    class C4023 : public IComponent {

    public:
        C4023(const std::string &name);
        ~C4023() override = default;
...
#endif /* OOP_NANOTEKSPICE_2018_C4023_HPP */

...
Test(C4071, basic)
{
    auto in = nts::Factory::createComponent("4071", "name");
...
{
    bool toPass = false;
    auto in = nts::Factory::createComponent("4071", "");
...
Test(C4071, linked, .init=redirect_all_std)
{
    auto out = nts::Factory::createComponent("4071", "out");

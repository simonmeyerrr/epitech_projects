...
Test(C4081, basic)
{
    auto in = nts::Factory::createComponent("4081", "name");
...
{
    bool toPass = false;
    auto in = nts::Factory::createComponent("4081", "");
...
Test(C4081, linked, .init=redirect_all_std)
{
    auto out = nts::Factory::createComponent("4081", "out");
    ...
    out->setLink(5, *in1, 1);
    out->setLink(6, *in2, 1);
    cr_assert_eq(out->compute(4), nts::FALSE);
    out->setLink(8, *in1, 1);
    out->setLink(9, *in2, 1);
    cr_assert_eq(out->compute(10), nts::FALSE);

...
Test(C4030, basic)
{
    auto in = nts::Factory::createComponent("4030", "name");
...
{
    bool toPass = false;
    auto in = nts::Factory::createComponent("4030", "");
...
Test(C4030, linked, .init=redirect_all_std)
{
    auto out = nts::Factory::createComponent("4030", "out");

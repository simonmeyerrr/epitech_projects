...
Test(C4011, basic)
{
    auto in = nts::Factory::createComponent("4011", "name");
...
{
    bool toPass = false;
    auto in = nts::Factory::createComponent("4011", "");
...
Test(C4011, linked, .init=redirect_all_std)
{
    auto out = nts::Factory::createComponent("4011", "out");
    ...
    cr_assert_eq(out->compute(11), nts::TRUE);
}
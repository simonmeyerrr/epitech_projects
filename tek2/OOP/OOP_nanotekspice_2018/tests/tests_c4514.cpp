...
Test(C4514, basic)
{
    auto in = nts::Factory::createComponent("4514", "name");
...
{
    bool toPass = false;
    auto in = nts::Factory::createComponent("4514", "");
...
Test(C4514, linked, .init=redirect_all_std)
{
    auto out = nts::Factory::createComponent("4514", "out");
